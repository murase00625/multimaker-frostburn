 ...
 * any attempt to set up graphic rendering or audio playback on the server will crash
 * the game.
 * 
 * Note that all of the methods in the CommonProxy are called from the main mod class. 
 * Forge will automatically use which subclass is appropriate for the situation.
 * 
...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		BlockDictionary.createBlocks();
		
		ItemDictionary.registerRecipes();
    }
